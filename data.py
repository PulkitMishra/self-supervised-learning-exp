...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(self.train_dataset, batch_size=self.batch_size, num_workers=8, pin_memory=True, drop_last=True)
    ...
    def val_dataloader(self):
        ...
        return DataLoader(self.val_dataset, batch_size=self.batch_size, num_workers=8, pin_memory=True, drop_last=True)
